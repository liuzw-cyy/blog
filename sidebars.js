...
const sidebars = {
  note: [
    ...
    },
    {
      ...
      link: {
        type: 'doc',
        id: 'A-guides/code-specification-guides'
      },
      items: [
        {
          type: 'autogenerated',
          dirName: 'code-specification',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          link: {
            type: 'doc',
            id: 'A-guides/JavaScript常用方法实现-guides',
          },
          items: [
            {
              type: 'autogenerated',
              dirName: 'js/JavaScript常用方法实现',
            }
          ]
        },
        {
          ...
          link: {
            type: 'doc',
            id: 'A-guides/JavaScript技巧-guides',
          },
          items: [
            {
              type: 'autogenerated',
              dirName: 'js/JavaScript技巧',
            }
          ]
        },
        {
          ...
          link: {
            type: 'doc',
            id: 'A-guides/JavaScript设计模式-guides',
          },
          items: [
            {
              type: 'autogenerated',
              dirName: 'js/JavaScript设计模式',
            }
          ]
        },
      ],
